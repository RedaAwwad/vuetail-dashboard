...
<template>
    <Transition name="fade">
        <div v-show="open"
            ...
            <div ref="modal" class="relative w-full max-w-2xl max-h-full transition ease-in-out"
                ...
                <Card>
                    <template #header>
                        ...
                        <div v-else class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
